    ...
    success: function(quoteData) {
      ...
      $("#item1").append(
        `<div class="row align-items-center justify-content-center" id="item1">
					...
					<div class="col-md-5 pr-4 mr-4">
						<div class="card-body">
							<h1 class="lead text-white" id="IDtext1">${quoteData[0].text}</p>
							<p class="text-white font-weight-bold" id="IDname1">${quoteData[0].name}</h5>
      ...
      $("#item2").append(
        `<div class="row align-items-center justify-content-center" id="item2">
					...
					<div class="col-md-5 pr-4 mr-4">
						<div class="card-body">
							<h1 class="lead text-white" id="IDtext2">${quoteData[1].text}</p>
							<p class="text-white font-weight-bold" id="IDname2">${quoteData[1].name}</h5>
