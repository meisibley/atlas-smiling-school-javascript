# Atlas / Holberton Smiling School (Bootstrap Project)
...
The Atlas / Holberton Smiling School web pages were developed by sections using the Bootstrap Front-End framework and CSS styles.
...
Mei Sibley: [meisibley](https://github.com/meisibley)
